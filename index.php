...
<head>
    ...
    <title>Home|Graymatter Works </title>
...
<body>
    ...
    <main>
        ...
        <section class="section-base section-overflow-top">
            <div class="container">
                ...
                <div class="row row-fit-lg" data-anima="fade-bottom" data-time="1000">
                    <div class="col-lg-6">
                        <ul class="slider" data-options="nav:false">
                            <li>
            ...
            <div class="container">
                <div class="row" data-anima="fade-bottom" data-time="1000">
                    ...
                    <div class="col-lg-6 align-right align-left-md">
                        ...
                        <p class="text-primary">All services</p>
                    </div>
                </div>
                <hr class="space" />
            ...
            <div class="container">
                <div class="row" data-anima="fade-bottom" data-time="1000">
                    <div class="col-lg-12">
                        ...
                        <hr class="space-xs" />
                        <ul class="slider " data-options="arrows:false,nav:true,perView:3,perViewMd:2,perViewXs:1,gap:30,controls:out">
                            <li>
        ...
        <section class="section-base section-overflow-top" id="contactus">
            <div class="container">
                <div class="row" data-anima="fade-bottom" data-time="1000">
                    <div class="col-lg-6">
                        <div class="title">
                            <h2>Get in touch and get<br />started today. We're<br>ready</h2>
                            <p>Contact us now</p>
                        </div>
                        <p>
                    ...
                    <div class="col-lg-6">
                        <form id="UCiFI" action="thtmekit/scripts/php/contact-form.php" class="form-box form-ajax form-ajax-wp" method="post" data-email="">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <input id="country" name="country" placeholder="Country" type="text" class="input-text" required="">
                                </div>
                                <div class="col-lg-4">
                                    <input id="Name" name="Name" placeholder="Company" type="text" class="input-text" required="">
                                </div>
                                <div class="col-lg-4">
